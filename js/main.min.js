...
"use strict";var $=jQuery.noConflict();$(function(){$(".rightside-menu__open").on("click",function(){$(".rightside-menu").toggleClass("rightside-menu--close")}),$(".rightside-menu__close").on("click",function(){$(".rightside-menu").addClass("rightside-menu--close")}),$(".burger__menu-overlay").on("click",function(){$(".rightside-menu").addClass("rightside-menu--close")})}),$(function(s){$(".reviews__slider").slick({dots:!1,arrows:!1,fade:!0,autoplay:!0})}),$(function(s){$(".car-model__slider").slick({dots:!1,nextArrow:'<img src="img/arrow-next.svg" alt="" class="arrow arrow-next">',prevArrow:'<img src="img/arrow-prev.svg" alt="" class="arrow arrow-prev">',slidesToShow:5,slidesToScroll:1,autoplay:!0,responsive:[{breakpoint:1280,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:720,settings:{slidesToShow:2,slidesToScroll:2}}]})});
